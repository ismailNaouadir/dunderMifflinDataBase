...
ORDER BY 
  ...
  first_name, 
  last_name;
-- Select the least 5 payed employess
SELECT 
  first_name, 
  last_name, 
...
LIMIT 
  5;
-- Select all different sexes of the employees
SELECT 
  DISTINCT sex 
from 
  employee;
...
-- (LEFT JOIN : all elements from the employee table)
SELECT 
  employee.emp_id, 
  employee.first_name, 
  branch.branch_name 
...
-- (RIGHT JOIN : all elements from the branch table)
SELECT 
  employee.emp_id, 
  employee.first_name, 
  branch.branch_name 
...
-- 4th type of JOIN called OUTER JOIN which is
...
VALUES 
  (
    109, 'Oscar', 'Martinez', '1968-02-19', 
    'M', 69000, 102, 2
  );
INSERT INTO employee 
VALUES 
  (
    110, 'Kevin', 'Malone', '1978-02-19', 
    'M', 69000, 102, 2
  );
INSERT INTO employee 
VALUES 
  (
    111, 'Pam', 'Beesly', '1988-02-19', 
    'F', 69000, 102, 2
  );
SELECT 
  * 
